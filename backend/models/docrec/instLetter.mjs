...
export const InstLetterMain = sequelize.define(
  'InstLetterMain',
  {
    ...
    iv_status: {
      ...
      validate: { isIn: [['Pending', 'Done', 'Correction', 'Post', 'Mail']] },
    },
...
export const InstLetterStudent = sequelize.define(
  'InstLetterStudent',
  {
    id: { type: DataTypes.BIGINT, primaryKey: true, autoIncrement: true },
...
export default { InstLetterMain, InstLetterStudent };
