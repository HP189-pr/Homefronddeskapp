...
import { normalizeMediaUrl, resolveProfilePictureOrNull } from "../utils/mediaUrl";

export default function ProfileUpdate({ setWorkArea }) {
    ...
    useEffect(() => {
        if (user) {
            ...
            const picUrl = resolveProfilePictureOrNull(user) || "";
            setProfile({
    ...
    const handleSubmit = async (e) => {
        ...
        // Append file if selected. Backend accepts both `usrpic` and `profile_picture`.
