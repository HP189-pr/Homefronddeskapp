...
const InOutRegister = () => {
  ...
  const [outwardFilters, setOutwardFilters] = useState({
    search: '',
    type: '',
    date_from: '',
    date_to: '',
  ...
  // Next number preview
  const [inwardNextNumber, setInwardNextNumber] = useState({
    last_no: null,
    next_no: null,
  });
  const [outwardNextNumber, setOutwardNextNumber] = useState({
    last_no: null,
    next_no: null,
  });
  ...
  const handleInwardSubmit = async (e) => {
    e.preventDefault();
    if (
      !inwardForm.inward_date ||
      !inwardForm.inward_type ||
      !inwardForm.inward_from
    ) {
    ...
    try {
      ...
      showAlert(
        ...
        error.response?.data?.detail ||
          error.response?.data?.inward_type?.[0] ||
          'Operation failed',
      );
    } finally {
      setLoading(false);
  ...
  const handleOutwardSubmit = async (e) => {
    e.preventDefault();
    if (
      !outwardForm.outward_date ||
      !outwardForm.outward_type ||
      !outwardForm.outward_to
    ) {
      showAlert('error', 'Please fill all required fields');
      return;
    }
    ...
    try {
      ...
      showAlert(
        'error',
        error.response?.data?.detail ||
          error.response?.data?.outward_type?.[0] ||
          'Operation failed',
      );
    } finally {
      setLoading(false);
      ...
      <div className="bg-white rounded shadow p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          <input
            ...
            onChange={(e) =>
              setInwardFilters({ ...inwardFilters, search: e.target.value })
            }
          ...
          <select
            ...
            onChange={(e) =>
              setInwardFilters({ ...inwardFilters, type: e.target.value })
            }
            className="border px-3 py-2 rounded"
          >
          ...
          <input
            ...
            onChange={(e) =>
              setInwardFilters({ ...inwardFilters, date_from: e.target.value })
            }
            className="border px-3 py-2 rounded"
          />
          <input
            ...
            onChange={(e) =>
              setInwardFilters({ ...inwardFilters, date_to: e.target.value })
            }
            className="border px-3 py-2 rounded"
          />
        </div>
      ...
      <div className="bg-white rounded shadow p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">
            {editingInward ? 'Edit' : 'Add'} Inward Register
          </h2>
          {!editingInward && inwardNextNumber.next_no && (
            <div className="text-sm">
              {inwardNextNumber.last_no && (
                <span className="text-orange-500 font-medium">
                  Last inward no: {inwardNextNumber.last_no}
                </span>
              )}
              <span className="ml-3 text-blue-600 font-medium">
                Next Inward: {inwardNextNumber.next_no}
              </span>
            </div>
          )}
        </div>
        ...
        >
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setInwardForm({ ...inwardForm, inward_date: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setInwardForm({ ...inwardForm, inward_from: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              required
            />
          ...
          <div>
            <label className="block text-sm font-medium mb-1">
              Rec Type <span className="text-red-500">*</span>
            </label>
            <select
              value={inwardForm.rec_type}
              onChange={(e) =>
                setInwardForm({ ...inwardForm, rec_type: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              required
            >
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                setInwardForm({ ...inwardForm, details: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              rows="2"
            />
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                setInwardForm({ ...inwardForm, remark: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              rows="2"
            />
  ...
  const renderOutwardTab = () => (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded shadow p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          <input
            ...
            onChange={(e) =>
              setOutwardFilters({ ...outwardFilters, search: e.target.value })
            }
            className="border px-3 py-2 rounded"
          />
          <select
            ...
            onChange={(e) =>
              setOutwardFilters({ ...outwardFilters, type: e.target.value })
            }
            className="border px-3 py-2 rounded"
          >
            <option value="">All Types</option>
          ...
          <input
            ...
            onChange={(e) =>
              setOutwardFilters({ ...outwardFilters, date_to: e.target.value })
            }
            className="border px-3 py-2 rounded"
          />
        </div>
      ...
      <div className="bg-white rounded shadow p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">
            {editingOutward ? 'Edit' : 'Add'} Outward Register
          </h2>
          {!editingOutward && outwardNextNumber.next_no && (
            <div className="text-sm">
              {outwardNextNumber.last_no && (
                <span className="text-orange-500 font-medium">
                  Last outward no: {outwardNextNumber.last_no}
                </span>
              )}
              <span className="ml-3 text-blue-600 font-medium">
                Next Outward: {outwardNextNumber.next_no}
              </span>
            </div>
          )}
        </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setOutwardForm({ ...outwardForm, outward_to: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              required
            />
          ...
          <div>
            <label className="block text-sm font-medium mb-1">
              Send Type <span className="text-red-500">*</span>
            </label>
            <select
              value={outwardForm.send_type}
              onChange={(e) =>
                setOutwardForm({ ...outwardForm, send_type: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              required
            >
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                setOutwardForm({ ...outwardForm, details: e.target.value })
              }
              className="w-full border px-3 py-2 rounded"
              rows="2"
            />
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">
        Document Register (Inward/Outward)
      </h1>
