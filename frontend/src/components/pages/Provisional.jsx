...
export default function Provisional() {
  ...
  const load = useCallback(async () => {
    ...
    const res = await authFetch(`/api/admin/provisionals?${params.toString()}`);
    if (res.ok) {
      ...
      {panelOpen && (
        <div className="p-4">
          ...
          >
            ...
            <div>
              <label htmlFor="provisional_number">Final Number</label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                type="text"
                name="provisional_scan_copy"
                id="provisional_scan_copy"
                value={form.provisional_scan_copy}
                onChange={onChange}
                className="border p-2 w-full"
              />
            </div>
        ...
        {items.map((row) => (
          ...
          >
            ...
            <div style={{ fontSize: 12, color: '#555' }}>
              ...
              <div>Final#: {row.provisional_number || '-'}</div>
